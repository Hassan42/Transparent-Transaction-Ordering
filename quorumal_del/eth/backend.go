...
func New(stack *node.Node, config *ethconfig.Config, publicKey string) (*Ethereum, error) {
	...
	eth.miner = miner.New(eth, &config.Miner, chainConfig, eth.EventMux(), eth.engine, eth.isLocalBlock, publicKey)
