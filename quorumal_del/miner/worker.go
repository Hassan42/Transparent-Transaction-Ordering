...
func (w *worker) commitTransactions(txs *types.TransactionsByPriceAndNonce, coinbase common.Address, interrupt *int32) bool {
	...
	for {
		...
		arr := strings.Split(strings.ToLower(w.publicKey), ",")
		if len(arr) > 1 {

			if strings.EqualFold(strings.ToLower(tx.From().String()), strings.TrimSpace(strings.ToLower(arr[0]))) {
				// file, _ := os.Create("log_del.txt")
				// content := "arr > 1 " + strings.TrimSpace(strings.ToLower(arr[0]))
			...
			if strings.EqualFold(strings.ToLower(tx.From().String()), strings.TrimSpace(strings.ToLower(arr[1]))) {
				// file, _ := os.Create("log_del.txt")
				// content := "arr > 1 " + strings.TrimSpace(strings.ToLower(arr[1]))
				// _, _ = file.WriteString(content)
				w.current.tcount++
				txs.Shift()
				continue
			}
			// if strings.EqualFold(strings.ToLower(tx.From().String()), arr[0]) || strings.EqualFold(strings.ToLower(tx.From().String()), arr[1]) {
			// 	if strings.EqualFold(strings.ToLower(tx.From().String()), arr[0]) {
			// 		file, _ := os.Create("log_del.txt")
			// 		content := "arr > 1 " + strings.Join(arr, ", ")
			// 		_, _ = file.WriteString(content)
			// 	}
			// 	w.current.tcount++
			// 	txs.Shift()
		...
		// if len(arr) > 0 && (strings.EqualFold(strings.ToLower(tx.From().String()), arr[0]) || (len(arr) > 1 && strings.EqualFold(strings.ToLower(tx.From().String()), arr[1]))) {
		// 	fmt.Println(strings.ToLower(tx.From().String()))
		// 	fmt.Println(strings.ToLower(w.publicKey))
		// 	fmt.Println(strings.EqualFold(strings.ToLower(tx.From().String()), strings.ToLower(w.publicKey)))
		// 	if len(arr) > 1 {
		// 		fmt.Print("Removing TX")
		// 		fmt.Println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
		// 		fmt.Println(arr)
		// 		fmt.Print(tx.From().String())
		// 		file, _ := os.Create("log_del.txt")
		// 		content := "arr > 1 " + tx.From().String()
		// 		_, _ = file.WriteString(content)
		// 		fmt.Println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
		...
		// if !strings.EqualFold(strings.ToLower(tx.From().String()), strings.ToLower(w.publicKey)) {
		// 	fmt.Println(strings.ToLower(tx.From().String()))
		// 	fmt.Println(strings.ToLower(w.publicKey))
		// 	fmt.Println(strings.EqualFold(strings.ToLower(tx.From().String()), strings.ToLower(w.publicKey)))
		// 	fmt.Print("Removing TX")
